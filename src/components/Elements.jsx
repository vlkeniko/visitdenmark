...
export default function Elements( ) {
  ...
  // Basically one component is used for showing all the locations
    ...
    <>
        ...
        <div>
        {
            toIterate.map(element =>(/* console.log(params.subcategoryid, element.Category.Id) */ parseInt(params.subcategoryid) === element.Category.Id ? <ElementItem element={element} key={element.id} /> : ""))
        }
        </div>
    </>
  )
